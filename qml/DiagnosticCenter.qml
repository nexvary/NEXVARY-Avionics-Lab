...
Item {
    ...
    function selected() {
        ...
        if (rows.length === 0) return {"code":"—","system":"—","category":"—","severity":"INFO","title":"No matching training code","meaning":"Adjust the search or filters.","cause":"—","isolation":"—","recovery":"—","sensor":""}
    ...
    function runScan() {
        ...
        if (cockpit.diagnosticFindings.length > 0) selectFinding(cockpit.diagnosticFindings[0].code)
    }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    MinisterialButton {
                        text: cockpit.rtl ? "تشغيل محرك التشخيص" : "RUN DIAGNOSTIC ENGINE"
                        implicitWidth: 178
                        accent: Theme.accent
            ...
            StatusCard { Layout.preferredWidth: 145; Layout.fillHeight: true; title: "HEALTH SCORE"; value: String(cockpit.diagnosticHealthScore); subtitle: "DIAGNOSTIC / 100"; iconText: "HS"; accent: cockpit.diagnosticHealthScore >= 90 ? Theme.green : (cockpit.diagnosticHealthScore >= 70 ? Theme.amber : Theme.red) }
            StatusCard { Layout.preferredWidth: 135; Layout.fillHeight: true; title: "FINDINGS"; value: String(cockpit.diagnosticFindingCount); subtitle: "RANKED"; iconText: "DX"; accent: cockpit.diagnosticFindingCount > 0 ? Theme.amber : Theme.accent }
            StatusCard { Layout.preferredWidth: 125; Layout.fillHeight: true; title: "FAULTS"; value: String(cockpit.diagnosticFaultCount); subtitle: "ACTIVE"; iconText: "F"; accent: cockpit.diagnosticFaultCount > 0 ? Theme.red : Theme.accent }
            StatusCard { Layout.preferredWidth: 135; Layout.fillHeight: true; title: "RECURRENT"; value: String(cockpit.diagnosticRecurrentCount); subtitle: "2+ SCANS"; iconText: "H"; accent: cockpit.diagnosticRecurrentCount > 0 ? Theme.amber : Theme.accent }
        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: cockpit.rtl ? "نتيجة الفحص الحي" : "LIVE DIAGNOSTIC SCAN"; color: Theme.platinum; font.pixelSize: 10; font.bold: true; Layout.fillWidth: true }
                        Text { text: cockpit.diagnosticScanTick > 0 ? "TICK " + cockpit.diagnosticScanTick : "NOT RUN"; color: Theme.accent; font.family: "Consolas"; font.pixelSize: 7 }
                    }
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                anchors.margins: 6
                                spacing: 6
                                Rectangle { width: 4; height: 35; color: page.severityColor(modelData.severity) }
                                ColumnLayout {
                                    Layout.fillWidth: true
                                    spacing: 0
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text { text: "SYSTEM / CATEGORY"; color: Theme.muted; Layout.preferredWidth: 150; font.pixelSize: 7 }
            ...
            Rectangle {
                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            Layout.fillWidth: true
                            Layout.preferredHeight: page.findingFor(page.selected().code) ? 92 : 58
                            color: Theme.panel2
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { text: cockpit.diagnosticFingerprint.length ? cockpit.diagnosticFingerprint : "NOT GENERATED"; color: Theme.accent; font.family: "Consolas"; font.pixelSize: 8; font.bold: true }
