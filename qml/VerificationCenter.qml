...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Repeater {
                model: [
                    ...
                    {"k":"FRAMES","v":String(cockpit.recordedFrames),"c":Theme.platinum},
                    ...
                    {"k":"FAULT LAB","v":cockpit.activeTrainingFaultCount===0?"NOMINAL":String(cockpit.activeTrainingFaultCount),"c":cockpit.activeTrainingFaultCount?Theme.amber:Theme.silver}
                ]
                delegate: Rectangle {
        ...
        Rectangle {
            ...
            Layout.maximumHeight: 72
            color: Theme.panel
            border.color: page.passCount()===6?Theme.accent:Theme.amber
            radius: Theme.radius
            RowLayout {
                anchors.fill: parent
                anchors.margins: 8
