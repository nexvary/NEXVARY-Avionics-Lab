    ...
    ColumnLayout { anchors.fill:parent; anchors.margins:10; spacing:7
        RowLayout { Layout.fillWidth:true; Layout.preferredHeight:82; spacing:7
            Rectangle { Layout.fillWidth:true; Layout.fillHeight:true; color:Theme.panel; border.color:Theme.border; radius:Theme.radius
                ColumnLayout { anchors.fill:parent; anchors.margins:10; spacing:1
                    ...
                    Text { text:cockpit.rtl?"الوقت، المصدر، الشدة، البحث، وسلسلة الأدلة":"TIME / SOURCE / SEVERITY / SEARCH / EVIDENCE CHAIN"; color:Theme.muted; font.pixelSize: 10 }
                }
            }
        ...
        Rectangle { Layout.fillWidth:true; Layout.preferredHeight:54; color:Theme.panel; border.color:Theme.border; radius:Theme.radius
            RowLayout { anchors.fill:parent; anchors.margins:8; spacing:6
                ...
                TextField { Layout.preferredWidth:360; placeholderText:cockpit.rtl?"ابحث في المصدر أو الرسالة":"Search source or message"; color:Theme.platinum; font.family:"Consolas"; font.pixelSize: 10; onTextChanged:page.query=text
                ...
                ColumnLayout { anchors.fill:parent; anchors.margins:7; spacing:1
                    Rectangle { Layout.fillWidth:true; Layout.preferredHeight:32; color:Theme.panel2; border.color:Theme.borderSoft
                        RowLayout { anchors.fill:parent; anchors.margins:6
                            Text { text:"TIME"; color:Theme.muted; Layout.preferredWidth:110; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
                            Text { text:"SEVERITY"; color:Theme.muted; Layout.preferredWidth:76; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
                            Text { text:"SOURCE"; color:Theme.muted; Layout.preferredWidth:150; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
                            Text { text:"MESSAGE / EVIDENCE"; color:Theme.muted; Layout.fillWidth:true; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
                        }
                    }
                    ListView { Layout.fillWidth:true; Layout.fillHeight:true; model:cockpit.eventRows; clip:true; spacing:1
                        delegate: Rectangle { required property int index; required property var modelData; property bool acceptedRow:page.accepted(modelData); width:ListView.view.width; height:acceptedRow?38:0; visible:acceptedRow; color:index%2?Theme.panel2:Theme.panel
                            RowLayout { anchors.fill:parent; anchors.margins:6
                                Text { text:modelData.time; color:Theme.silver; Layout.preferredWidth:110; font.family:"Consolas"; font.pixelSize: 10 }
                                Text { text:modelData.severity; color:page.sevColor(modelData.severity); Layout.preferredWidth:76; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
                                Text { text:modelData.source; color:Theme.accent; Layout.preferredWidth:150; font.family:"Consolas"; font.pixelSize: 10; elide:Text.ElideRight }
                                Text { text:modelData.message; color:Theme.platinum; Layout.fillWidth:true; font.pixelSize: 10; elide:Text.ElideRight }
                            }
                        }
                    }
                }
                ...
                ColumnLayout { anchors.fill:parent; anchors.margins:8; spacing:5
                    ...
                    Rectangle { Layout.fillWidth:true; Layout.preferredHeight:88; color:Theme.panel2; border.color:Theme.border; radius:Theme.radius
                        ColumnLayout { anchors.fill:parent; anchors.margins:8; spacing:3
                            Text { text:"TRACEABILITY"; color:Theme.muted; font.pixelSize: 10 }
                            Text { text:"SCENARIO → EVENT → HEALTH → REPORT"; color:Theme.platinum; font.family:"Consolas"; font.pixelSize: 10 }
                            Text { text:cockpit.rtl?"أدلة تدريب ومحاكاة فقط":"TRAINING / SIMULATION EVIDENCE ONLY"; color:Theme.muted; font.pixelSize: 10 }
                        }
                    }
                }
            }
