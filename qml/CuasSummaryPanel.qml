...
Rectangle {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Text { text: root.rtl ? "ملخص استجابة C-UAS" : "C-UAS RESPONSE SUMMARY"; color: Theme.platinum; font.pixelSize: 10; font.bold: true; Layout.fillWidth: true }
            Text { text: root.highCount > 0 ? (root.rtl ? "مراجعة" : "REVIEW") : "NOMINAL"; color: root.highCount > 0 ? Theme.warmOrange : Theme.radarGreen; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
        }
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        anchors.margins: 6
                        spacing: 1
                        Text { text: modelData.n; color: modelData.c; font.family:"Consolas"; font.pixelSize: 10; font.bold:true }
                        Item { Layout.fillHeight: true }
                        Text { text: String(modelData.v); color: modelData.c; font.family:"Consolas"; font.pixelSize:16; font.bold:true }
                        Text { text: root.rtl ? modelData.ar : modelData.en; color: Theme.platinum; font.pixelSize: 10; font.bold:true; Layout.fillWidth:true; elide:Text.ElideRight }
                    }
                }
            }
        }
