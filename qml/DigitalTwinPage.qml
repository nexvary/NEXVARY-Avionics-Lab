    ...
    ColumnLayout { anchors.fill:parent; anchors.margins:10; spacing:7
        RowLayout { Layout.fillWidth:true; Layout.preferredHeight:82; spacing:7
            Rectangle { Layout.fillWidth:true; Layout.fillHeight:true; color:Theme.panel; border.color:Theme.border; radius:Theme.radius
                ColumnLayout { anchors.fill:parent; anchors.margins:10; spacing:1
                    ...
                    Text { text:cockpit.rtl?"ترابط الأنظمة، دمج البيانات، ومراقبة حالة النموذج":"SYSTEM INTERCONNECT / DATA FUSION / MODEL STATE"; color:Theme.muted; font.pixelSize: 10 }
                }
            }
            ...
            Rectangle { Layout.fillWidth:true; Layout.fillHeight:true; color:Theme.panel; border.color:Theme.border; radius:Theme.radius
                ColumnLayout { anchors.fill:parent; anchors.margins:8; spacing:4
                    RowLayout { Layout.fillWidth:true
                        ...
                        Text { text:cockpit.twinFaultCount===0?"SYNCHRONIZED":"DEGRADED"; color:cockpit.twinFaultCount===0?Theme.accent:Theme.amber; font.family:"Consolas"; font.pixelSize: 10 }
                    }
                    Rectangle { Layout.fillWidth:true; height:1; color:Theme.border }
                    Item { Layout.fillWidth:true; Layout.fillHeight:true
                        ...
                        Rectangle { anchors.left:parent.left; anchors.right:parent.right; anchors.bottom:parent.bottom; height:34; color:Theme.panel2; border.color:Theme.border; radius:Theme.radius
                            RowLayout { anchors.fill:parent; anchors.margins:6
                                Text { text:"DATA FUSION"; color:Theme.silver; font.pixelSize: 10; font.bold:true }
                                Text { text:cockpit.sensorCount+" CHANNELS"; color:Theme.accent; font.family:"Consolas"; font.pixelSize: 10 }
                                Text { text:cockpit.twinRows.length+" SUBSYSTEMS"; color:Theme.silver; font.family:"Consolas"; font.pixelSize: 10 }
                                Item { Layout.fillWidth:true }
                                Text { text:"STATE AGREEMENT / SYNTHETIC"; color:Theme.muted; font.family:"Consolas"; font.pixelSize: 10 }
                            }
                        }
                    }
                }
                ...
                ColumnLayout { anchors.fill:parent; anchors.margins:8; spacing:5
                    ...
                    Rectangle { Layout.fillWidth:true; Layout.preferredHeight:92; color:Theme.panel2; border.color:Theme.border; radius:Theme.radius
                        ColumnLayout { anchors.fill:parent; anchors.margins:8; spacing:3
                            Text { text:"MODEL STATUS"; color:Theme.muted; font.pixelSize: 10 }
                            ...
                            Text { text:"NOM "+cockpit.twinNominalCount+"  •  DEG "+cockpit.twinDegradedCount+"  •  FLT "+cockpit.twinFaultCount; color:Theme.silver; font.family:"Consolas"; font.pixelSize: 10 }
                        }
                    }
                }
            }
        ...
        Rectangle { Layout.fillWidth:true; Layout.preferredHeight:42; color:Theme.panel; border.color:Theme.border; radius:Theme.radius
            RowLayout { anchors.fill:parent; anchors.margins:7
                Text { text:"DIGITAL TWIN EVIDENCE"; color:Theme.silver; font.pixelSize: 10; font.bold:true }
                Text { text:"FRAMES "+cockpit.recordedFrames; color:Theme.accent; font.family:"Consolas"; font.pixelSize: 10 }
                Text { text:"EVENTS "+cockpit.eventCount; color:Theme.silver; font.family:"Consolas"; font.pixelSize: 10 }
                Item { Layout.fillWidth:true }
                Text { text:cockpit.rtl?"بيانات محاكاة تدريبية فقط":"SYNTHETIC TRAINING DATA ONLY"; color:Theme.muted; font.pixelSize: 10 }
            }
        }
    }
}
